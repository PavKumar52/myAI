  ...
  return (
    <div className="w-full flex justify-center p-10">
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <h1 className="text-3xl font-bold">BlueMBA Buddy</h1>
        <h2 className="text-2xl font-semibold">
          Terms of Use and Disclaimer for BlueMBA Buddy
        </h2>
        <ol className="list-decimal list-inside space-y-4">
          <li className="text-gray-700">
            <span className="font-semibold">Acceptance of Terms:</span> By
            accessing and using the AI chatbot ("BlueMBA Buddy") provided by Pavithra
          ...
          <li className="text-gray-700">
            ...
            or implied. Pavithra makes no representations or warranties regarding
          ...
          <li className="text-gray-700">
            ...
            Pavithra does not guarantee that the Chatbot will be available at all
          ...
          <li className="text-gray-700">
            ...
            the fullest extent permitted by applicable law, Pavithra shall not be
          ...
          <li className="text-gray-700">
            ...
            decisions made based on its output. Pavithra is not responsible for any
          ...
          <li className="text-gray-700">
            ...
            considered equivalent to public postings, and the owner does not
          ...
          <li className="text-gray-700">
            ...
            indemnify, defend, and hold harmless Pavithra from any claims,
            liabilities, damages, losses, and expenses, including reasonable
            legal fees, arising from your use of the Chatbot or violation of
            these Terms of Use.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">Modifications to Terms:</span> The owner
          ...
          <li className="text-gray-700">
            ...
            contact Pavithra at pavithra.mk9352@gmail.com.
          </li>
        </ol>
      </div>
    </div>
